...
This is the design template I used is from freehtml5 (it's a free template):
...
Before you upload the angular_email.sql file to phpmyadmin

Open the file and change the username and password.

Then export all the files (execpt the img-preview, it's images of the application) into your domain (for example www.yourcompanyname.com)

To access the admin section: www.yourcompanyname.com/launch_admin/
